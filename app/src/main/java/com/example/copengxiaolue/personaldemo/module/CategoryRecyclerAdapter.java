...
public class CategoryRecyclerAdapter extends CommonRecyclerAdapter<GankResult.ResultBean> {
    public CategoryRecyclerAdapter(Context mContext, List<GankResult.ResultBean> mData) {
